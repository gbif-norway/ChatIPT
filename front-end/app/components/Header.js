  ...
  return (
    <nav className={`navbar navbar-expand-lg border-bottom ${isDark ? 'navbar-dark bg-dark' : 'navbar-light bg-light'}`}>
      <div className="container">
        <h1 
          className={`navbar-brand mb-0 ${ibmPlexSerif.className} ${onBackToDashboard ? 'cursor-pointer' : ''} d-flex align-items-center`} 
          style={{
